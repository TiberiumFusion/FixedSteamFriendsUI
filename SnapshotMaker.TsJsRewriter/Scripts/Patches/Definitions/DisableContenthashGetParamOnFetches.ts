...
{
    export class DisableContenthashGetParamOnFetchesCPDF extends ConfiguredPatchDefinitionFactory
    {
        PatchIdName = "DisableContenthashGetParamOnFetches";
        ...
        CreatePatchDefinition(): PatchDefinition
        {
            return new PatchDefinition(this.PatchIdName,
                ...
                (context: ts.TransformationContext, sourceFile: ts.SourceFile, node: ts.Node, detectionInfoData: any) =>
                {
                    ...
                    {
                        let tnode: ts.StringLiteral = detectionInfoData.TypedNode; // e.g.  ".css?contenthash="
