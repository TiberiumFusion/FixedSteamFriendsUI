...
//export = ts; // this turns this file into a module
// Commented out b/c modules break namespaces. The old typescriptServices.d.ts file does exactly this; it is identical to typescript.d.ts, except the "export = ts" line is omitted.
